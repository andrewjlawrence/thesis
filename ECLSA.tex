...
The statement of completeness for the DPLL proof system has been modified from the one described in Chapter \ref{}. It additionally contains an assumption to allow for the inclusion of a more complicated branching heuristic, which computes a variable ordering at the start of the program and then 

\begin{lstlisting}[caption = The Completeness Theorem for the Modified DPLL Proof System in Minlog]
