...
\item The nc-quantifiers (See Section \ref{sec:realizability})are treated in the same way as their non-nc counter parts in terms of how natural deduction is implemented. 
