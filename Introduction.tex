...
\medskip \\
\textbf{Chapter 7}: Provides an overview of the model checking techniques used in this thesis for verification. \medskip \\
\textbf{Chapter 8}: Compares X-SAT with another verified SAT algorithm and an industrial tool on pigeon hole formulae and on the real world application of verifying a solid state railway interlocking.
\medskip \\
