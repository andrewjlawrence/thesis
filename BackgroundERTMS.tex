...
\filldraw [blue] (3.9,0.33) rectangle (4.5, 0.45);
%%% Draw ETCS
\node[rectangle, black, fill = white, draw ] at (3.4 , 0.3) {ETCS};
...
\centering
 ...
 \caption{Movement Authorities in ETCS Level 1}
\label{fig:trackplan}
\end{figure}
\end{center}
...
\draw[->](0,8.5) -- node[above = 7pt,left = 3pt, font = \small]{Points Set} (4, 8.5);
\draw[<-](0, 8) -- node[above = 7pt, right = 2pt, font = \small]{Points Ack} (4, 8);  
\draw[->](0,7.5) -- node[above = 7pt,left = 28pt, font = \small]{MA D $\to$ C} (6, 7.5);
\draw[<-](0, 7) -- node[above = 7pt, right = 34pt, font = \small]{MA Ack} (6, 7);  
\draw[<-](0, 6.5) -- node[above = 7pt, right = 28pt, font = \small]{Position Rep} (6, 6.5);  


\draw[->](0, 5) -- node[above, font = \small ]{Route Req} (2, 5);
\draw[<-](0, 4.5) -- node[above, font = \small]{Route Ack}(2,4.5); 
\draw[->](0,4) -- node[above = 7pt,left = 3pt, font = \small]{Points Set} (4, 4);
\draw[<-](0, 3.5) -- node[above = 7pt, right = 2pt, font = \small]{Points Ack} (4, 3.5);  
\draw[->](0,3) -- node[above = 7pt,left = 56pt, font = \small]{MA A $\to$ B} (8, 3);
