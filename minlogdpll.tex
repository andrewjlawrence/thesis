...
We have formalised the incompatibility proof for the DPLL proof system following the proof found in chapter \ref{chapter:DPLL}. We shall now sketch some of the steps to carry out the proof using the Minlog System.
...
\begin{center}
\textbf{Model-Full} := \texttt{all mod, l. (mod l -> F) -> mod (opposite l)} \\
\end{center}
