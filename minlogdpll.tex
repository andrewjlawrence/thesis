...
%containing  $\forallnc$ quantifier s
...
%
%FRED: what do we count? The output of the translation is 204 lines, but
% some of those lines are pretty long...
% My suggestion: report the number of lines after manual formatting (I
% guess this is what we are doing now, but some current choices seem
% to use a lot of lines, see e.g. list_clalist_clavalugrecguard in the
% appendix).
%
...
%
%FRED: not true at the moment! Really, the extracted program takes a valuation
% Gamma and two formulae Delta, Theta, assumes Gamma is consistent and produces
% a model of Delta /\ Theta or a derivation of Gamma |- Delta /\ Theta.
%
% ANDY: This has now been changed in the Minlog code. 
% The formalization of the completeness theorem may need to be changed to reflect this. 
...
\end{verbatim}
%
%FRED: Could we just present this version and say that we have
% added nc-quantifiers by hand?
%
...
\begin{lstlisting}[caption = "The derivation produce by X-SAT for PHP(2\,1)"]
CsuccessZero
 (CUnit
  (Pos(Variable 11))
  (CUnit
