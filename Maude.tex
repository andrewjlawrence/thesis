...
\begin{mydef}[Live transition system]
Given a labeled transition system $LTS = (S,T,S_0,L)$ and a state $s \in S$. We define a $q_0$-\emph{rooted} \emph{trajectory} of  $LTS$ to be a finite or  infinite $$
\end{mydef}
