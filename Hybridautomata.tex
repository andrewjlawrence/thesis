...
\item $T$ is ternary  relation $S \xrightarrow{a} S$ of type $S \times L \times S$, over the state space $S$.
...
\begin{mytheorem}[Interlocking Automaton is Non-Zeno]
