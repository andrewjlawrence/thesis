...
In the following we shall describe the behaviour of the prototype clause learning algorithm when applied to some simple examples. We can apply the solver to a small example formula containing two unit clauses as follows:
